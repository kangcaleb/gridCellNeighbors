...
public class ManhattanDistanceNeighborFinderTest {
    ManhattanDistanceNeighborFinder manhattanDistanceNeighborFinder = Mockito.spy(ManhattanDistanceNeighborFinder.class);

    @Test
    public void testDistance1InSmallGrid() {
        int[][] grid = new int[3][3];
        grid[1][1] = 1;
        int result = manhattanDistanceNeighborFinder.findTotalCellCountWithinRange(grid, 1);
    ...
    public void testDistance0Returns1() {
        ...
        grid[2][2] = 1;
        int result = manhattanDistanceNeighborFinder.findTotalCellCountWithinRange(grid, 0);
    ...
    public void testDistanceCoversEntireGrid() {
        int[][] grid = new int[5][5];
        grid[2][2] = 10;
        int result = manhattanDistanceNeighborFinder.findTotalCellCountWithinRange(grid, 10);
    ...
    public void testDistance3In6x6Grid() {
        ...
        grid[2][3] = 11;
        int result = manhattanDistanceNeighborFinder.findTotalCellCountWithinRange(grid, 3);
    ...
    public void testDistance11In22x22Grid() {
        ...
        grid[10][11] = 11;
        int result = manhattanDistanceNeighborFinder.findTotalCellCountWithinRange(grid, 11);
    ...
    public void exampleThreeDisjointNeighborhoods() {
        ...
        grid[7][3] = 1;
        grid[3][7] = 1;
        int result = manhattanDistanceNeighborFinder.findTotalCellCountWithinRange(grid, 2);
    ...
    @Test
    public void testWrappedHorizontalNeighbor() {
        int[][] grid = new int[3][3];
        grid[1][0] = 1; // Positive cell on far left
        int result = manhattanDistanceNeighborFinder.findTotalCellCountWithinRange(grid, 1);
        assertEquals(5, result);
    }

    @Test
    public void testWrappedVerticalNeighbor() {
        int[][] grid = new int[3][3];
        grid[0][1] = 1;
        int result = manhattanDistanceNeighborFinder.findTotalCellCountWithinRange(grid, 1);
        assertEquals(5, result);
    ...
    @Test
    public void testWrappedDoesNotIncludeDiagonal() {
        int[][] grid = new int[3][3];
        grid[0][0] = 1; // Corner cell
        int result = manhattanDistanceNeighborFinder.findTotalCellCountWithinRange(grid, 1);
        assertEquals(5, result);
    }
